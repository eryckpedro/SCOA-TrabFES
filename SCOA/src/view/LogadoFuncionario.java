...
public class LogadoFuncionario extends Logado {
    ...
    public LogadoFuncionario(){
    	...
    	JLabel lblAreaDoFuncionario = new JLabel("<html><div style='font-size: 16px; border-bottom: 2px solid black; padding: 0 2px; margin-bottom: 10px;'>Área do funcionário</div></html>");
    	...
    	tabbedPane.addTab("Consultas", new VerFuncionarios());    	
