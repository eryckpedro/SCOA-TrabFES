...
public class InscricaoTurma extends Listar {
	...
	public InscricaoTurma() {
		...
		JLabel lblNewLabel = new JLabel("Por favor, selecione a turma em que deseja se cadastrar no momento:");
		lblNewLabel.setBorder(new EmptyBorder(10, 5, 10, 10) );
		...
		horizontalBox.setBorder(new EmptyBorder(10, 5, 3, 1) );
