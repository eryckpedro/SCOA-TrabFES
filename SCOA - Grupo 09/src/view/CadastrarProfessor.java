...
public class CadastrarProfessor extends Cadastrar {
	...
	public CadastrarProfessor() {
		...
		JLabel lblPorVavorEntre = new JLabel("Por favor, entre com as informações do professor que deseja cadastrar:");
